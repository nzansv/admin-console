...
export default function UserTable(props) {
    const [isListOfUsers, setIsListOfUsers] = useState([]);
    ...
    const getUsers = async () => {
        try {
            let res = await axios.get(`/mail-app/api/getAllUsers?page=${isTree.currentPage}&size=10`);
            setIsListOfUsers(res.data);
            console.log("ddd>>>", res);
        } catch (err) {
            console.log(err)
        }
    ...
    const onClickToPage = (props) => {
        isTree = {currentPage: props};
    }
                ...
                <div className="userTable">
                    <div className="upperTableToDo">
                        ...
                        <div className="toDoButton">
                            <a href="#" className="btn btn-primary"><img src={add} alt=""/> <Link id="login-button"
                                                                                                  to="/userCreate">Создать</Link></a>
                            ...
                            <a href="#" id="btn-reload"><img src={reload} alt=""/></a>
                        </div>
                    </div>
                            ...
                            <tbody>
                            {
                                isListOfUsers.map((user, i) => (
                                    <tr>
                                        ...
                                        <td><a href="#">{user.iin ? user.iin : '-'}</a></td>
                                        <td>{user.login}</td>
                    ...
                    <div className="pagination-box container-fluid">
                        <nav>
                            <ul className="pagination justify-content-end">
                                ...
                                <li className="page-item"> <a className="page-link" href="#" onClick={onClickToPage(2)}>1</a> </li>
                                ...
                                {/*    </svg>*/}
                                {/*</a></li>*/}
                                {/*<li className="page-item"><a className="page-link" href="#" onClick={setIsTree({*/}
                                {/*    currentPage: 2*/}
                                {/*})}>2</a></li>*/}
